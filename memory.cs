...
public partial class uOm9OjMDZp7QZnrK85
{
    #region Custom

    public static uOm9OjMDZp7QZnrK85 _0m = new uOm9OjMDZp7QZnrK85();
    ...
    public bool DumpMemory(string file = "dump.dmp")
    {
        ...
        Int64 proc_max_address_l = (Int64)Process.VirtualMemorySize64 + proc_min_address_l;
        ...
        while (proc_min_address_l < proc_max_address_l)
        {
            ...
            ReadProcessMemory(Handle, test2, buffer, test, IntPtr.Zero);
